...
function ValidatorPage() {
    ...
    return (_jsx("div", { className: "min-h-screen gradient-bg", children: _jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsxs("div", { className: "text-center mb-8", children: [_jsx("h1", { className: "text-4xl font-bold text-foreground mb-2", children: "Validador de Ingressos" }), _jsxs("p", { className: "text-xl text-muted-foreground", children: ["Ol\u00E1,", " ", _jsx("span", { className: "font-semibold text-green-600 dark:text-green-400", children: user?.email }), "!"] }), _jsx("p", { className: "text-muted-foreground mt-2", children: "Valide ingressos de forma r\u00E1pida e segura" }), backendStatus && (_jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: backendStatus }))] }), _jsx(ScannerSection, { userProfile: userProfile, scannerActive: scannerActive, onScan: (code) => {
                        setTicketCode(code);
                        setScannerActive(false);
                        handleValidate(code);
                    }, onError: () => {
                        setScannerActive(false);
                    } }), _jsxs("div", { className: "grid lg:grid-cols-2 gap-8", children: [_jsxs(Card, { children: [_jsxs(CardHeader, { className: "text-center", children: [_jsx(CardTitle, { className: "text-2xl", children: "Validar Ingresso" }), _jsx("p", { className: "text-muted-foreground", children: "Digite o c\u00F3digo do ingresso para validar" })] }), _jsx(CardContent, { children: _jsx(ValidatorForm, { ticketCode: ticketCode, setTicketCode: setTicketCode, onSubmit: handleFormSubmit, isValidating: isValidating, onReset: handleReset, userProfile: userProfile, validationStatus: validationResult.status, generateTestCode: generateTestCode, createTestData: createTestData, isCreatingTestData: isCreatingTestData }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { className: "text-center", children: _jsx(CardTitle, { className: "text-2xl", children: "Resultado da Valida\u00E7\u00E3o" }) }), _jsx(CardContent, { children: _jsx("div", { id: "validation-result", role: "status", "aria-live": "polite", children: _jsx(ValidationResult, { status: validationResult.status, message: validationResult.message, ticketData: validationResult.ticketData, onConfirm: () => {
