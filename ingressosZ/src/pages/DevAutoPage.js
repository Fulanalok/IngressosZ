...
function DevAutoPage() {
    ...
    return (_jsx("div", { className: "min-h-screen gradient-bg flex items-center justify-center", children: _jsxs("div", { className: "card p-6 text-center", children: [_jsx("h1", { className: "text-2xl font-bold text-foreground mb-2", children: "Dev Auto Setup" }), _jsx("p", { className: "text-muted-foreground", children: status })] }) }));
}
