      ...
      <main className="page-container">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] items-center">
            <div>
              <h2 className="mt-4 text-6xl font-extrabold tracking-tighter leading-tight text-foreground">
                Sua próxima <span className="blue-gradient-text">experiência</span> começa aqui
              </h2>
              <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
                Compre ingressos com Pix ou cartão em segundos. Receba tudo no celular e
                entre sem filas. Seguro, rápido e 100% digital.
              </p>
          ...
          <section className="mb-20">
            <div className="flex justify-between items-end mb-10">
              <div>
                ...
                <p className="text-muted-foreground">Os eventos mais aguardados da temporada.</p>
              </div>
              <Button variant="ghost" asChild className="group text-primary hover:text-primary font-bold">
                <Link to="/eventos">Ver todos <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" /></Link>
              </Button>
            </div>
        ...
        <section className="mb-24 py-12">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">A tecnologia que você precisa com a simplicidade que você merece.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group text-center p-8 rounded-3xl bg-card border border-border/40 hover:border-primary/30 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Pagamentos criptografados via Mercado Pago e ingressos validados com assinatura digital.
              </p>
            </div>
            ...
            <div className="group text-center p-8 rounded-3xl bg-card border border-border/40 hover:border-primary/30 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Garanta sua presença em segundos com Pix. Aprovação em tempo real e sem burocracia.
              </p>
            </div>
            ...
            <div className="group text-center p-8 rounded-3xl bg-card border border-border/40 hover:border-primary/30 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Acesse seu QR Code direto no navegador, sem precisar instalar nada. Funciona offline na entrada.
              </p>
            </div>
          </div>
        </section>
