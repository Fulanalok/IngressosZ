...
function QRCodeDisplay({ qrCode, size = 200, }) {
    ...
    if (error) {
        return (_jsx("div", { className: "bg-red-50 border-2 border-red-200 rounded-none flex items-center justify-center", style: { width: size, height: size }, children: _jsx("div", { className: "text-center text-red-600", children: _jsx("div", { className: "text-xs", children: "Erro no QR" }) }) }));
    }
