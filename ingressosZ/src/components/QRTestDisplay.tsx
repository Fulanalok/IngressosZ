...
function QRTestDisplay({
  ...
  <div className="max-w-md mx-auto bg-white rounded-none shadow-lg p-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-4">
          Use este QR code para testar o scanner
        </p>

        {qrCodeUrl ? (
          <div className="space-y-4">
  <div className="bg-white p-4 rounded-none border-2 border-gray-200 inline-block">
              <img
                src={qrCodeUrl}
  ...
  <div className="bg-blue-50 p-3 rounded-none">
          ...
          <div className="py-8">
        <div className="animate-spin rounded-none h-8 w-8 border-b-2 border-primary-600 mx-auto"></div>
