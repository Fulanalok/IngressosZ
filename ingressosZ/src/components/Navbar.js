...
function Navbar() {
    ...
    return (_jsx("nav", { className: "nav-bg", children: _jsx("div", { className: "page-container", children: _jsxs("div", { className: "flex justify-between items-center h-16", children: [_jsx(Link, { to: "/", className: "flex items-center text-foreground hover:text-primary transition-colors", children: _jsx("span", { className: "text-xl font-bold", children: "IngressosZ" }) }), _jsxs("div", { className: "hidden md:flex items-center space-x-6", children: [_jsx(Link, { to: "/", className: `nav-link ${isActive("/") && location.pathname === "/"
                                    ? "text-foreground"
