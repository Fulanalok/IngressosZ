...
export function TicketPurchase({ event, user, onClose }) {
  ...
  if (paymentStatus === "succeeded") {
    return _jsx("div", {
      ...
      children: _jsxs("div", {
        className:
          "bg-background rounded-lg shadow-xl p-8 max-w-md w-full text-center",
        children: [
          _jsx(StatusScreen, {
  ...
  return _jsx("div", {
    ...
    children: _jsxs("div", {
      className:
        "bg-background rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col",
      children: [
        _jsxs("div", {
          className:
          ...
          children: [
            _jsxs("div", {
              children: [
                _jsx("label", {
                  ...
                  children: "Tipo de Ingresso",
                }),
                _jsx("div", {
                  className: "space-y-3",
                  children: Object.entries(TICKET_TYPES).map(([type, info]) => {
                                        ...
                                        _jsxs("p", {
                                          ...
                                          children: [
                                            ...
                                            isSoldOut &&
                                              _jsx("span", {
                                                className:
                                                  "ml-2 text-xs font-bold text-red-500 uppercase",
                                                children: "(Esgotado)",
                                              }),
                                          ],
                                        }),
                          ...
                          _jsxs(
                            "option",
                            {
                              ...
                              children: [
                                num,
                                " ",
                                num === 1 ? "ingresso" : "ingressos",
                              ],
                            },
                            num
                          )
                        )
                      : _jsx("option", { value: 0, children: "0 ingressos" }),
                }),
              ],
            }),
            checkoutError &&
            ...
            !user &&
              _jsx("p", {
                ...
                children: "Fa\u00E7a login para continuar com a compra.",
              }),
          ],
        }),
        _jsx("div", {
          className:
            "p-6 mt-auto border-t border-border bg-muted/50 rounded-b-2xl",
          children:
