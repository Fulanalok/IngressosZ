...
function EventCard({ event }) {
    ...
    return (_jsxs("div", { ref: rootRef, className: "group card hover:shadow-large transition-all duration-300 hover:-translate-y-1 max-w-sm bg-background", onMouseEnter: prefetchDetails, onFocus: prefetchDetails, children: [event.image && (_jsxs("div", { className: "relative mb-4 overflow-hidden rounded-t-xl", children: [_jsx("img", { src: event.image, alt: event.title, loading: "lazy", decoding: "async", className: "w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105" }), _jsx("div", { className: "absolute top-3 left-3", children: _jsx("span", { className: `px-2 py-1 text-xs font-medium rounded-none ${getCategoryColor(event.category)}`, children: event.category }) }), event.availableTickets <= 10 && event.availableTickets > 0 && (_jsx("div", { className: "absolute top-3 right-3", children: _jsx("span", { className: "bg-red-500 text-white px-2 py-1 text-xs font-medium rounded-none", children: "\u00DAltimos ingressos!" }) }))] })), _jsxs("div", { className: "space-y-3", children: [_jsx("h3", { className: "text-lg font-semibold text-foreground line-clamp-2 group-hover:text-primary transition-colors", children: event.title }), _jsxs("div", { className: "space-y-2 text-sm text-muted-foreground", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("span", { className: "mr-2", children: "\uD83D\uDCC5" }), _jsx("span", { className: "font-medium", children: "Data:" }), _jsx("span", { className: "ml-1", children: formattedDate })] }), _jsxs("div", { className: "flex items-center", children: [_jsx("span", { className: "mr-2", children: "\uD83D\uDD50" }), _jsx("span", { className: "font-medium", children: "Hor\u00E1rio:" }), _jsx("span", { className: "ml-1", children: formattedTime })] }), _jsxs("div", { className: "flex items-center", children: [_jsx("span", { className: "mr-2", children: "\uD83D\uDCCD" }), _jsx("span", { className: "font-medium", children: "Local:" }), _jsx("span", { className: "ml-1 truncate", children: event.location })] })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center text-primary", children: [_jsx("span", { className: "mr-2 text-lg", children: "\uD83D\uDCB0" }), _jsxs("span", { className: "text-xl font-bold", children: ["R$", " ", (event.pricing?.standard ??
                                                event.price ??
                                                0).toFixed(2)] })] }), _jsxs("div", { className: `text-xs font-medium ${event.availableTickets > 10
                                    ? "text-gray-500 dark:text-gray-400"
                                    : "text-red-600 dark:text-red-400"}`, children: ["\uD83C\uDFAB ", event.availableTickets, " dispon\u00EDveis"] })] }), _jsx("div", { className: "w-full bg-muted rounded-none h-1.5", children: _jsx("div", { className: "bg-gradient-to-r from-primary to-accent h-1.5 rounded-none transition-all duration-300", style: {
                                width: `${((event.maxTickets - event.availableTickets) /
                                    event.maxTickets) *
                                    100}%`,
                            } }) }), _jsx(Button, { asChild: true, className: "w-full", disabled: event.availableTickets === 0, children: _jsx(Link, { to: `/evento/${event.id}`, className: "block", onMouseEnter: prefetchDetails, onFocus: prefetchDetails, children: event.availableTickets > 0 ? (_jsxs("span", { className: "flex items-center justify-center", children: [_jsx("span", { className: "mr-2", children: "\uD83D\uDED2" }), "Ver Detalhes & Comprar"] })) : (_jsxs("span", { className: "flex items-center justify-center", children: [_jsx("span", { className: "mr-2", children: "\u274C" }), "Esgotado"] })) }) })] })] }));
}
